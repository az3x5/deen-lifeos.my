...
import { ChevronLeft, PlayCircle, PauseCircle, StopCircle, RefreshCw, ChevronDown, Play, Pause, X, SkipForward, BookOpenText, Search } from 'lucide-react';
             ...
             <div className="space-y-6">
               {ayahs.arabic.map((ayah, index) => {
                 ...
                 <div 
                    key={ayah.number} 
                    id={`ayah-${ayah.number}`}
                    className={`bg-white dark:bg-slate-900 p-5 md:p-8 rounded-3xl border transition-all duration-500 ${
                        isPlaying 
  ...
  return (
    <div className="space-y-8 animate-in fade-in">
      <div className="relative bg-slate-50/95 dark:bg-slate-950/95 backdrop-blur-sm pt-2 pb-6 z-10 border-b border-transparent transition-all">
        <h2 className="text-2xl md:text-3xl font-bold text-slate-800 dark:text-slate-100 tracking-tight mb-4">Quran Kareem</h2>
